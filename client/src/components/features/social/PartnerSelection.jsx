...
const PartnerSelection = ({ onPartnerSelect }) => {
    ...
    return (
        <div className="space-y-6">
            ...
            {/* Active Partnerships */}
            <div className="bg-black/60 p-6 rounded-xl border border-blue-500/20">
                <h3 className="text-lg font-medium text-white mb-4">Active Partnerships</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {partnerships.length === 0 ? (
                        <p className="text-neutral-300 text-center col-span-2">No active partnerships</p>
                    ) : (
                        partnerships.map(partnership => {
                            ...
                            return (
                                <motion.div
                                    ...
                                    className="bg-black/40 p-4 rounded-lg border border-blue-500/10 cursor-pointer 
                                                 hover:border-blue-500/30 transition-all duration-300"
                                >
                                    <div className="flex items-center space-x-4">
                                        <div className="h-12 w-12 bg-gradient-to-r from-blue-500 to-blue-700 rounded-full flex items-center justify-center">
            ...
            <div className="bg-black/60 p-6 rounded-xl border border-blue-500/20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {friends.length === 0 ? (
                        <p className="text-neutral-300 text-center col-span-2">
                            ...
                            .map(friend => (
                                ...
                                >
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center space-x-4">
                                            <div className="h-12 w-12 bg-gradient-to-r from-blue-500/20 to-blue-500/20 rounded-full flex items-center justify-center">
                                                <span className="text-white font-bold">
