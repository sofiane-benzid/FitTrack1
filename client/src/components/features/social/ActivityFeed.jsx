    ...
    const renderActivity = (activity) => {
        ...
        return (
            <motion.div
                ...
                className="bg-black/60 rounded-xl border border-blue-500/20 overflow-hidden mb-4"
            >
                {/* Activity Header */}
                <div className="p-4 border-b border-blue-500/20">
                    ...
                    <div className="mt-3">
                        ...
                        {activity.notes && (
                            <p className="text-neutral-300 mt-2">{activity.notes}</p>
                        )}
                    </div>
                </div>

                {/* Reactions */}
                <div className="p-3 bg-black/40 border-b border-blue-500/20">
                ...
                <div className="p-4">
                    {Array.isArray(activity.comments) && activity.comments.map((comment) => {
                        ...
                        return (
                            ...
                            >
                                <div className="w-8 h-8 rounded-full bg-gradient-to-r from-blue-500/20 to-blue-500/20 flex items-center justify-center">
        ...
        <div className="space-y-4">
            ...
            {activities.length === 0 ? (
                <motion.div
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    className="text-center py-8 bg-black/60 rounded-xl border border-blue-500/20"
                >
                    <p className="text-neutral-200">No activities in your feed yet</p>
