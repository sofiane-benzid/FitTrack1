...
const DebugLogs = ({ logs }) => (
    <div className="text-xs font-mono bg-black/90 text-neutral-200 p-2 max-h-32 overflow-y-auto space-y-1">
        {logs.map((log, i) => (
            <div key={i} className="border-b border-blue-500/20 py-1">
        ...
        <div className="p-4 bg-black/40 rounded-lg border border-blue-500/20">
            <div className="flex flex-col gap-2">
                <motion.button
                    ...
                    className="w-full py-2 bg-gradient-to-r from-blue-500 to-blue-700 text-white rounded-lg"
                >
                ...
                <motion.button
                    ...
                    className="relative w-full py-2 bg-black/40 text-white rounded-lg border border-blue-500/20"
                >
    ...
    return (
        ...
        >
            <motion.div
                ...
                className="bg-black/90 p-6 rounded-xl border border-blue-500/20 w-full max-w-sm mx-4"
            >
                {/* Header */}
                ...
                {/* Error Message */}
                {error && (
                    <div className="mb-4 p-3 bg-blue-500/20 border border-blue-500/40 rounded-lg text-blue-400 whitespace-pre-line">
                        {error}
                    </div>
                )}
                ...
                <form onSubmit={handleManualSubmit} className="mb-4 space-y-4">
                    <div>
                        ...
                        <input
                            ...
                            className="w-full px-3 py-2 bg-black/40 border border-blue-500/20 rounded-lg text-white placeholder-gray-500 focus:border-blue-500"
                        ...
                        <div className="relative aspect-square mb-4 overflow-hidden rounded-lg bg-black/40">
                            ...
                            {!isScanning ? (
                                <div className="absolute inset-0 flex items-center justify-center bg-black/60">
                                    <span className="text-neutral-200">Camera preview</span>
                                </div>
                            ) : (
