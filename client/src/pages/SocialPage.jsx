    ...
    <div className="min-h-screen bg-black">
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16 items-center">
            <span className="text-lg md:text-xl font-bold bg-gradient-to-r from-blue-500 to-blue-700 bg-clip-text text-transparent">
              Social Hub
            </span>
            ...
            <div className="flex items-center space-x-2 md:space-x-4">
              ...
              <motion.button
                ...
                className="p-2 md:hidden text-neutral-200 hover:text-blue-400"
                aria-label="Menu"
              >
          ...
          <div className="grid md:grid-cols-[240px,1fr] gap-4 md:gap-6 mt-4 md:mt-6">
            ...
            <div className="space-y-4 md:space-y-6">
              ...
              <motion.div
                ...
                className="border-b border-blue-500/20 mb-4 md:mb-6"
              >
                      ...
                      {selectedPartner ? (
                        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                          <motion.button
                            ...
                            className="w-full md:w-auto px-4 py-3 md:py-2 bg-black/40 text-white rounded-lg border border-blue-500/20"
                          >
                            ← Back to Partners
                          </motion.button>
                        </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-8">
                      ...
                      <div className="space-y-4">
                        ...
                        <motion.button
                          ...
                          className="w-full md:w-auto px-4 py-3 md:py-2 bg-gradient-to-r from-blue-500 to-blue-700 text-white rounded-lg"
                        >
                          Scan QR Code
                        </motion.button>
                      </div>
      ...
      <AnimatePresence>
        {selectedChat && (
          ...
          >
            <div className="w-full max-w-2xl h-[90vh] md:h-[600px] bg-black/90 rounded-xl border border-blue-500/20">
              <ChatWindow
                chatId={selectedChat}
